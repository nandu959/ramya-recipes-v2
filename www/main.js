...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"tabbar__content ons-tabbar__content ons-swiper\"\n  style=\"touch-action: pan-y; -webkit-user-drag: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);overflow: auto;\">\n  <div style=\"padding: 1px 0 0 0;\" *ngFor=\"let item of feeds?.rss?.channel?.item\">\n    <div class=\"card\">\n      <img [src]=\"item?.mediathumbnail?.url\" alt=\"Onsen UI\" style=\"width: 100%\">\n      <div class=\"title\">\n        {{item?.title}}\n      </div>\n    </div>\n  </div>\n</div>\n<div class=\"tabbar tabbar--bottom tabbar--material\">\n  <label class=\"tabbar__item tabbar--material__item\">\n    <input type=\"radio\" name=\"tabbar-material-c\">\n    <button class=\"tabbar__button tabbar--material__button\">\n      <i class=\"tabbar__icon tabbar--material__icon zmdi zmdi-favorite\"></i>\n      <div class=\"tabbar__label tabbar--material__label\">Favorites</div>\n    </button>\n  </label>\n\n  <label class=\"tabbar__item tabbar--material__item\">\n    <input type=\"radio\" name=\"tabbar-material-c\" checked=\"checked\">\n    <button class=\"tabbar__button tabbar--material__button\">\n      <i class=\"tabbar__icon tabbar--material__icon zmdi zmdi-pizza\"></i>\n      <div class=\"tabbar__label tabbar--material__label\">Recipes</div>\n    </button>\n  </label>\n\n  <label class=\"tabbar__item tabbar--material__item\">\n    <input type=\"radio\" name=\"tabbar-material-c\">\n    <button class=\"tabbar__button tabbar--material__button\">\n      <i class=\"tabbar__icon tabbar--material__icon zmdi zmdi-layers\"></i>\n      <div class=\"tabbar__label tabbar--material__label\">Categories</div>\n    </button>\n  </label>\n\n  <label class=\"tabbar__item tabbar--material__item\">\n    <input type=\"radio\" name=\"tabbar-material-c\">\n    <button class=\"tabbar__button tabbar--material__button\">\n      <i class=\"tabbar__icon tabbar--material__icon zmdi zmdi-menu\"></i>\n      <div class=\"tabbar__label tabbar--material__label\">More</div>\n    </button>\n  </label>\n</div>");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            entryComponents: [_categories_categories_component__WEBPACK_IMPORTED_MODULE_5__["CategoriesComponent"], _recipe_recipe_component__WEBPACK_IMPORTED_MODULE_7__["RecipeComponent"], _about_about_component__WEBPACK_IMPORTED_MODULE_6__["AboutComponent"], _favorites_favorites_component__WEBPACK_IMPORTED_MODULE_8__["FavoritesComponent"]],
            providers: [],
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(_http) {
        this._http = _http;
        this.favorites = _favorites_favorites_component__WEBPACK_IMPORTED_MODULE_3__["FavoritesComponent"];
        this.recipes = _recipe_recipe_component__WEBPACK_IMPORTED_MODULE_5__["RecipeComponent"];
        this.categories = _categories_categories_component__WEBPACK_IMPORTED_MODULE_6__["CategoriesComponent"];
        this.more = _about_about_component__WEBPACK_IMPORTED_MODULE_4__["AboutComponent"];
        this.loadFeeds();
    }
    HomeComponent.prototype.ngOnInit = function () { };
    HomeComponent.prototype.loadFeeds = function () {
        var _this = this;
        this._http.get('https://cors-anywhere.herokuapp.com/https://ramyarecipesblog.wordpress.com/feed/', {
            ...
            _this.feeds = JSON.parse(xml2json(data, '  '));
            _this.feeds.rss.channel.item.forEach(function (i) {
                i.mediathumbnail = i["media:thumbnail"];
            });
            console.log(_this.feeds.rss.channel.item);
        });
    };
...
module.exports = __webpack_require__(/*! C:\Users\DevTesting\Desktop\rr-project\ramya-recipes\src\main.ts */"./src/main.ts");
